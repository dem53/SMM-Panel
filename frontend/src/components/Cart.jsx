...
function Cart({ isCartOpen, setIsCartOpen, onAddToCart, onRemoveFromCart, onClearCart, cartItems }) {
                            ...
                            <div key={index} className="flex items-center justify-between border-b pb-3">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 font-semibold">{item.product.tags}</p>
                                ...
                                <div className="flex cursor-pointer flex-col py-1 rounded-lg justify-evenly items-center gap-2 shadow-sm border border-gray-400">
                                    <button
                                        ...
                                        className="text-green-500 transition-colors cursor-pointer duration-300 ease-in-out px-2 rounded-full text-xs font-semibold"
                                    >
                                        +
                                    </button>
                                    ...
                                    <button
                                        ...
                                        className="text-red-500 transition-colors cursor-pointer duration-300 ease-in-out px-2 rounded-full text-xs font-semibold"
                                    >
                                        -
                                    </button>
                                </div>
